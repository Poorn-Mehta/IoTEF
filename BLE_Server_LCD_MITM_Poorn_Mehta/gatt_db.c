...
GATT_DATA(const struct bg_gattdb_buffer_with_len	bg_gattdb_data_attribute_field_23 ) = {
	.len=19,
	.data={0x02,0x19,0x00,0x89,0x62,0x13,0x2d,0x2a,0x65,0xec,0x87,0x3e,0x43,0xc8,0x38,0x02,0x00,0x00,0x00,}
};
...
uint8_t bg_gattdb_data_attribute_field_6_data[17]={0x54,0x65,0x6d,0x70,0x20,0x53,0x65,0x72,0x76,0x65,0x72,0x20,0x50,0x6f,0x6f,0x72,0x6e,};
...
GATT_DATA(const struct bg_gattdb_attribute bg_gattdb_data_attributes_map[])={
    ...
    {.uuid=0x8003,.permissions=0x811,.caps=0xffff,.datatype=0x01,.min_key_size=0x00,.dynamicdata=&bg_gattdb_data_attribute_field_24},
};

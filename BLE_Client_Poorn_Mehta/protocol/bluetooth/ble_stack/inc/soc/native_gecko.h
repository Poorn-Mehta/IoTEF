...
* The returned value in the response is the selected maximum output power level
* after applying RF path compensation.
* If the GATT server contains a Tx Power service, the Tx Power Level attribute
* of the service will be updated accordingly.
